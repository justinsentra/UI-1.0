...
export function InfoTooltip({ text }: InfoTooltipProps) {
  ...
  return (
    ...
    >
      ...
      />
      {isVisible && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-[280px] px-3 py-2 bg-[var(--fg-base)] text-white text-xs leading-relaxed rounded-lg shadow-lg z-50 pointer-events-none">
          {text}
