...
export const meetings: Meeting[] = [
  ...
  // David Chen — Secondary Offering Discussion (today)
  {
    id: "mtg-7",
    ...
    keyPoints: [
      {
        ...
        description:
          "David wants to move within the next 60 days given the favorable market window created by the Apex-Cobalt merger. Suggested targeting a $50M raise at a 25% secondary stake.",
      ...
      },
      {
        ...
        description:
          "Margaret confirmed FY26 revenue tracking 8% above forecast at $52.5M. EBITDA margins expanding to 29%. Two new enterprise mandates signed in February are the primary driver.",
        participants: ["Margaret Liu"],
      },
    ],
    actionItems: [
      {
      ...
      },
      {
        ...
        description:
          "Incorporate the Q3 actuals and FY26 forecast into the preliminary memo. Include the Apex-Cobalt comp and updated valuation range.",
        assignee: "Nathan Lim",
        checked: false,
      },
      {
    ...
    transcript: [
      ...
      {
        speaker: "Margaret Liu",
        text: "On the financial side, Q3 actuals came in strong. Revenue is tracking about 8% above our prior forecast — $52.5M for the full year now looks very achievable. EBITDA margins are expanding, sitting at 29% with the two new mandates signed in February.",
        isMe: false,
      },
      {
        speaker: "Nathan Lim",
        text: "Those numbers are solid. Combined with the Apex-Cobalt comp, I think the base case valuation has moved up meaningfully. We should be looking at 3.8x to 4.2x on revenue, which puts us in the $200M to $220M range.",
        isMe: false,
      },
      {
        speaker: "David Chen",
  ...
  // Oracle Migration Project Review (today)
  {
    id: "mtg-8",
    ...
    keyPoints: [
      {
        ...
        description:
          "DataBridge Solutions missed two consecutive data delivery deadlines (Week 3 and Week 5), each time without proactive communication. The engineering team was blocked and had to context-switch.",
        participants: ["James Whitfield"],
      },
      {
      ...
      },
      {
        ...
        description:
          "Go-live pushed from March 14 to April 18. Any further vendor delays would push into Q3. Team agreed to daily check-ins until the next DataBridge delivery is confirmed.",
    ...
    actionItems: [
      ...
      {
        id: "ai-8-2",
        title: "Schedule escalation call with DataBridge account lead",
        description:
          "Book a 30-minute call to discuss SLA compliance, the two missed deadlines, and revised delivery commitments.",
    ...
    transcript: [
      ...
      },
      {
        ...
        text: "That's exactly right. The first miss was February 3 — they cited schema complexity. The second was February 17, resource constraints. Each time, my team was completely blocked and had to context-switch to other work.",
        isMe: false,
      },
      {
        speaker: "Mark Davis",
  ...
  // ── Additional past meetings (days 3–21) ──

  {
    id: "mtg-10",
    title: "FinServ Global — Procurement Alignment",
    date: daysAgo(3),
    time: "10:00 AM",
    endTime: "10:45 AM",
    duration: "45 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "Jordan Patel", "FinServ Procurement"],
    tags: ["Deal Review"],
    summary: "Aligned on procurement gates and MSA timeline for FinServ close by end of month.",
    keyPoints: [{ title: "PO target end of March", description: "Legal cleared, security in progress.", participants: ["Tracy Kim"] }],
    actionItems: [{ id: "ai-10-1", title: "Send SOC 2 packet", description: "Infosec to send within 48 hours.", assignee: "Infosec", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "Let's walk through the remaining procurement gates.", isMe: true }],
  },
  {
    id: "mtg-11",
    title: "CS Platform Pilot Check-In",
    date: daysAgo(3),
    time: "2:00 PM",
    endTime: "2:30 PM",
    duration: "30 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Rachel Adams", "Pilot CSMs"],
    tags: ["Internal"],
    summary: "Day 5 pilot feedback — all three CSMs report time savings and no blockers.",
    keyPoints: [{ title: "2.5 hrs/week saved", description: "Across all three pilot CSMs.", participants: ["Rachel Adams"] }],
    actionItems: [{ id: "ai-11-1", title: "Build Slack alerts", description: "Route health score drops to team channel.", assignee: "RevOps", checked: false }],
    transcript: [{ speaker: "Rachel Adams", text: "How's the first week been for everyone?", isMe: false }],
  },
  {
    id: "mtg-12",
    title: "APAC Expansion — Weekly Steering",
    date: daysAgo(4),
    time: "9:00 AM",
    endTime: "9:45 AM",
    duration: "45 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Lisa Park", "David Okonkwo", "Ken Yamada"],
    tags: ["Strategy"],
    summary: "Japan QA at 80%. Australia post-launch follow-up yielding strong pipeline.",
    keyPoints: [{ title: "12 qualified leads from Sydney", description: "BDR team qualifying against ICP.", participants: ["Lisa Park"] }],
    actionItems: [{ id: "ai-12-1", title: "Close Japan QA gaps", description: "Billing and compliance copy remaining.", assignee: "Ken Yamada", checked: false }],
    transcript: [{ speaker: "Lisa Park", text: "Let's start with Australia launch follow-up numbers.", isMe: false }],
  },
  {
    id: "mtg-13",
    ...
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "SA Team", "TechCorp Engineering"],
    tags: ["Deal Review"],
    summary: "Walked through SSO, SCIM, and audit logging. No show-stoppers identified.",
    keyPoints: [{ title: "No blockers on SSO", description: "Open items tracked as P2.", participants: ["SA Team"] }],
    actionItems: [{ id: "ai-13-1", title: "Send integration spec", description: "Follow up with SSO documentation.", assignee: "SA Team", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "Let's go through the integration requirements one by one.", isMe: true }],
  },
  {
    id: "mtg-14",
    title: "Pipeline Review — $3.8M Discussion",
    date: daysAgo(7),
    time: "10:00 AM",
    endTime: "11:00 AM",
    duration: "60 min",
    platform: "Zoom",
    privacy: "private",
    participants: ["Tracy Kim", "CRO", "RVPs"],
    tags: ["Deal Review"],
    summary: "Pipeline at $3.8M vs $5M target. Agreed to prioritize resurrected deals and tighten stage definitions.",
    keyPoints: [{ title: "Gap to target", description: "$1.2M gap — need to accelerate 3 deals.", participants: ["CRO"] }],
    actionItems: [{ id: "ai-14-1", title: "Update stage criteria", description: "RevOps to enforce new definitions.", assignee: "RevOps", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "We're $1.2M short of our Q2 commit. Let's talk about what we can move.", isMe: true }],
  },
  {
    id: "mtg-15",
    ...
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "NovaCare IT Lead"],
    tags: ["Deal Review"],
    summary: "Identified pain around reporting latency and manual exports. Qualified as enterprise ICP.",
    keyPoints: [{ title: "Strong ICP fit", description: "Reporting pain aligns with our core value prop.", participants: ["Tracy Kim"] }],
    actionItems: [{ id: "ai-15-1", title: "Schedule security scoping", description: "Next step before proposal.", assignee: "Tracy Kim", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "Tell me about your current reporting workflow.", isMe: true }],
  },
  {
    id: "mtg-16",
    title: "Oracle Migration — Integration Testing Kickoff",
    date: daysAgo(8),
    time: "9:00 AM",
    endTime: "10:00 AM",
    duration: "60 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["James Whitfield", "All Service Leads"],
    tags: ["Internal"],
    summary: "Aligned on environment promotion rules, smoke suite ownership, and daily defect triage.",
    keyPoints: [{ title: "Postgres staging ready", description: "Full test runs can begin.", participants: ["James Whitfield"] }],
    actionItems: [{ id: "ai-16-1", title: "Start daily defect triage", description: "9am slot booked for the next 2 weeks.", assignee: "Engineering", checked: false }],
    transcript: [{ speaker: "James Whitfield", text: "We're ready to kick off integration testing. Let me walk through the process.", isMe: false }],
  },
  {
    id: "mtg-17",
    title: "Series C — Deck Review with Qatalyst",
    date: daysAgo(9),
    time: "11:00 AM",
    endTime: "12:00 PM",
    duration: "60 min",
    platform: "Zoom",
    privacy: "private",
    participants: ["Tracy Kim", "CEO", "Qatalyst Partners"],
    tags: ["Strategy"],
    summary: "Bankers asked for sharper competitive moat narrative. Deck v2 due next week.",
    keyPoints: [{ title: "Moat slide needs work", description: "Need clearer defensibility vs incumbents.", participants: ["Qatalyst Partners"] }],
    actionItems: [{ id: "ai-17-1", title: "Revise moat slide", description: "Add customer cohort data and switching costs.", assignee: "Tracy Kim", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "What's your feedback on the competitive positioning?", isMe: true }],
  },
  {
    id: "mtg-18",
    title: "Meridian Health VP Call",
    date: daysAgo(10),
    time: "2:00 PM",
    endTime: "3:00 PM",
    duration: "60 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "Sarah Chen", "Meridian VP Ops"],
    tags: ["Deal Review"],
    summary: "VP confirmed expansion intent. Deal value increased from $420K to $520K with expanded scope.",
    keyPoints: [{ title: "Deal expanded to $520K", description: "Multi-year with add-on modules.", participants: ["Tracy Kim"] }],
    actionItems: [{ id: "ai-18-1", title: "Send POC proposal", description: "Due by March 6.", assignee: "Sarah Chen", checked: true }],
    transcript: [{ speaker: "Tracy Kim", text: "Thank you for making time. We're excited about the expansion opportunity.", isMe: true }],
  },
  {
    id: "mtg-19",
    ...
    platform: "Zoom",
    privacy: "public",
    participants: ["James Whitfield", "Engineering Managers"],
    tags: ["Internal"],
    summary: "Quantified context-switch costs from vendor delays. 30% of migration squad redirected to tech debt.",
    keyPoints: [{ title: "Context-switch cost: 1 week", description: "When vendor data arrives, ramp-up will take ~5 business days.", participants: ["James Whitfield"] }],
    actionItems: [{ id: "ai-19-1", title: "Document idle cost", description: "Finance requested burn estimate.", assignee: "James Whitfield", checked: false }],
    transcript: [{ speaker: "James Whitfield", text: "Let's talk about where the team stands while we wait on the vendor.", isMe: false }],
  },
  {
    id: "mtg-20",
    title: "Vendor Escalation — DataBridge",
    date: daysAgo(12),
    time: "9:00 AM",
    endTime: "9:45 AM",
    duration: "45 min",
    platform: "Zoom",
    privacy: "private",
    participants: ["James Whitfield", "Legal", "Finance"],
    tags: ["Escalation"],
    summary: "Reviewed SLA credits and step-in rights after second missed delivery. Preferred recovery plan over termination.",
    keyPoints: [{ title: "Recovery over termination", description: "Switching vendors would add more delay.", participants: ["Legal"] }],
    actionItems: [{ id: "ai-20-1", title: "Draft recovery plan", description: "Vendor to deliver by next week.", assignee: "James Whitfield", checked: false }],
    transcript: [{ speaker: "James Whitfield", text: "Legal, what are our options given the two missed deadlines?", isMe: false }],
  },
  {
    id: "mtg-21",
    ...
    platform: "Zoom",
    privacy: "public",
    participants: ["Lisa Park", "GTM Leads", "Support Ops"],
    tags: ["Strategy"],
    summary: "Final checklist for March 17 launch: billing in AUD, support hours, and Harbour Digital messaging signed off.",
    keyPoints: [{ title: "Launch ready", description: "All systems go for March 17 Sydney event.", participants: ["Lisa Park"] }],
    actionItems: [{ id: "ai-21-1", title: "Confirm support coverage", description: "APAC hours need to be live by Mar 17.", assignee: "Support Ops", checked: true }],
    transcript: [{ speaker: "Lisa Park", text: "Let's go through the launch readiness checklist one last time.", isMe: false }],
  },
  {
    id: "mtg-22",
    ...
    platform: "Zoom",
    privacy: "private",
    participants: ["Tracy Kim", "CRO", "Finance"],
    tags: ["Strategy"],
    summary: "Confirmed $5M enterprise goal. Gap owners named per region. Weighted baseline at $4.2M after cleanup.",
    keyPoints: [{ title: "$5M target confirmed", description: "Gap owners assigned by region.", participants: ["CRO"] }],
    actionItems: [{ id: "ai-22-1", title: "Regional gap plans", description: "Each RVP to submit plan by EOW.", assignee: "RVPs", checked: false }],
    transcript: [{ speaker: "Tracy Kim", text: "Let's finalize our Q2 targets and make sure everyone is aligned.", isMe: true }],
  },
  {
    id: "mtg-23",
    title: "Vitally Onboarding — Scoring Workshop",
    date: daysAgo(14),
    time: "3:00 PM",
    endTime: "4:00 PM",
    duration: "60 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Rachel Adams", "CS Leadership", "RevOps"],
    tags: ["Internal"],
    summary: "Built composite health score model. Validated against manual scores for top 20 accounts — 91% correlation.",
    keyPoints: [{ title: "91% correlation", description: "Model aligns well with manual CSM assessments.", participants: ["Rachel Adams"] }],
    actionItems: [{ id: "ai-23-1", title: "Finalize weights", description: "Lock model before pilot.", assignee: "Rachel Adams", checked: true }],
    transcript: [{ speaker: "Rachel Adams", text: "Let's look at how the automated scores compare to your manual assessments.", isMe: false }],
  },
  {
    id: "mtg-24",
    ...
    platform: "Zoom",
    privacy: "private",
    participants: ["CEO", "Board Members", "Tracy Kim", "CFO"],
    tags: ["Strategy"],
    summary: "Approved APAC market entry. Reviewed Series C timeline. Budget of $400K allocated for expansion.",
    keyPoints: [{ title: "APAC approved", description: "$400K budget for Japan and Australia entry.", participants: ["Board Members"] }],
    actionItems: [{ id: "ai-24-1", title: "Hire APAC lead", description: "Open the req for Sydney AE.", assignee: "HR", checked: false }],
    transcript: [{ speaker: "CEO", text: "Let's discuss the APAC opportunity and the resource ask.", isMe: false }],
  },
  {
    id: "mtg-25",
    title: "TechCorp Deal Resurrection",
    date: daysAgo(17),
    time: "2:00 PM",
    endTime: "2:45 PM",
    duration: "45 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "TechCorp AE", "Product"],
    tags: ["Deal Review"],
    summary: "AE reopened opportunity after product fix shipped. Champion confirmed issue resolved.",
    keyPoints: [{ title: "Deal back to active", description: "Product fix for their blocker shipped last week.", participants: ["TechCorp AE"] }],
    actionItems: [{ id: "ai-25-1", title: "Schedule tech deep-dive", description: "Architecture session with their engineering.", assignee: "SA Team", checked: true }],
    transcript: [{ speaker: "Tracy Kim", text: "Great news on the fix shipping. What's the champion saying?", isMe: true }],
  },
  {
    id: "mtg-26",
    title: "Executive Sponsorship Planning",
    date: daysAgo(18),
    time: "11:00 AM",
    endTime: "12:00 PM",
    duration: "60 min",
    ...
    participants: ["Tracy Kim", "CRO", "RVPs"],
    tags: ["Strategy"],
    summary: "Mapped exec allies to the eight stalled deals. CRO asked for weekly readouts.",
    keyPoints: [{ title: "Exec paths mapped", description: "Each stalled deal now has a named exec sponsor.", participants: ["CRO"] }],
    actionItems: [{ id: "ai-26-1", title: "Weekly exec readout", description: "Start Friday cadence until all deals have movement.", assignee: "Tracy Kim", checked: false }],
    transcript: [{ speaker: "CRO", text: "For each of these stalled deals, I want a named executive path. No exceptions.", isMe: false }],
  },
  {
    id: "mtg-27",
    title: "Vendor Data Validation Review",
    date: daysAgo(19),
    time: "10:30 AM",
    endTime: "11:00 AM",
    duration: "30 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["James Whitfield", "Priya Nair", "Contract DBA"],
    tags: ["Internal"],
    summary: "Row-level validation on initial vendor extract. Early variance under 0.02%.",
    keyPoints: [{ title: "Data quality good", description: "Variance well within tolerance across sampled tables.", participants: ["Priya Nair"] }],
    actionItems: [{ id: "ai-27-1", title: "Complete full validation", description: "Run remaining table comparisons.", assignee: "Contract DBA", checked: false }],
    transcript: [{ speaker: "James Whitfield", text: "What's the variance looking like on the high-cardinality tables?", isMe: false }],
  },
  {
    id: "mtg-28",
    title: "Japan Localization — QA Review",
    date: daysAgo(20),
    time: "9:00 AM",
    endTime: "9:30 AM",
    duration: "30 min",
    platform: "Zoom",
    privacy: "public",
    participants: ["Lisa Park", "Ken Yamada", "NihonLoc PM"],
    tags: ["Internal"],
    summary: "QA report showed 34% failure rate. Machine-translated segments found in key flows. Vendor given remediation window.",
    keyPoints: [{ title: "34% QA failure", description: "Terminology guide not applied consistently.", participants: ["Ken Yamada"] }],
    actionItems: [{ id: "ai-28-1", title: "Vendor remediation", description: "NihonLoc to retranslate affected keys by Mar 21.", assignee: "NihonLoc PM", checked: false }],
    transcript: [{ speaker: "Ken Yamada", text: "The QA results are concerning. 34% of strings failed our cultural adaptation review.", isMe: false }],
  },
  {
    id: "mtg-29",
    ...
    platform: "Zoom",
    privacy: "public",
    participants: ["Tracy Kim", "RevOps", "Sales Ops"],
    tags: ["Deal Review"],
    summary: "RevOps exported six months of stage history. Aligned on definitions for stalled vs. nurture deals.",
    keyPoints: [{ title: "Stalled = 30+ days no activity", description: "New definition agreed by all.", participants: ["RevOps"] }],
    actionItems: [{ id: "ai-29-1", title: "Flag stalled deals", description: "Run report and assign rescue owners.", assignee: "RevOps", checked: true }],
    transcript: [{ speaker: "Tracy Kim", text: "We need a clear definition of stalled that everyone agrees on.", isMe: true }],
  },
];
