...
const BUILTIN_EM_FLOWS: DocumentFlowConfig[] = [
  {
    ...
    doneMessage: {
      ...
      link: { label: "Open in SharePoint", url: "https://docs.google.com/document/d/1odXL_yJ2zopDNLL2RcnHhE_X7EzeTJtdCmJoj5x3awc/edit?usp=drive_web&ouid=113010372682429477039" },
    },
...
const BUILTIN_JPM_FLOWS: DocumentFlowConfig[] = [
  {
    ...
    doneMessage: {
      ...
      link: { label: "Open in Excel", url: "https://docs.google.com/spreadsheets/d/1ld5wxkZ9fX8A96QxdJW1rVjFR158POqgFQsb9yLxP6U" },
    },
  ...
  },
  {
    ...
    doneMessage: {
      ...
      link: { label: "Open in PowerPoint", url: "https://docs.google.com/presentation/d/1V3jHzNokqZUftWaLtY4bIjgxIrEnm8K48_mB_3MRnrw/edit" },
    },
