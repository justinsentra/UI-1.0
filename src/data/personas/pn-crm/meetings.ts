...
export const meetings: Meeting[] = [
  {
    ...
    privacy: "private",
    summary:
      "Reviewed pre-seed fundraising strategy with advisors. Discussed positioning Personal Network CRM against Clay, Folk, and Dex, zeroing in on the relationship intelligence layer as the core differentiator. Agreed on a target of $500K pre-seed by end of Q2 with focus on angel investors from the networking/CRM space. Also aligned on submitting the YC S26 application and refining the pitch deck with stronger retention metrics and competitive framing.",
    keyPoints: [
      {
      ...
      },
      {
        ...
        description:
          "Katherine advised framing the $5M cap as conservative given the traction, which creates urgency for angels. Suggested anchoring on the retention curve and NPS rather than raw user count since investors are wary of vanity metrics.",
        participants: ["Katherine McIntosh", "Zachary Carlo"],
      },
    ],
    actionItems: [
      {
    ...
    transcript: [
      {
        speaker: "Mark Richey",
        text: "Alright Zach, let's talk fundraising. Where are you at with the pre-seed? I know you've been heads down on product — give us the full picture.",
      },
      {
      ...
      {
        speaker: "Mark Richey",
        text: "Those are solid numbers. The question is how you differentiate from Clay. They just raised a massive round and they're all over LinkedIn right now. Every investor is going to ask about it.",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Katherine McIntosh",
        text: "That's a good framing, but you need to make it crisper. In the pitch, lead with the problem — everyone has a network, nobody manages it well. Then show the intelligence layer as the unlock. Don't spend time on why you're not Clay; spend time on why this category needs to exist.",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Mark Richey",
        text: "Absolutely include that. Named logos from funds carry weight, even if they're just beta users. Now, have you thought about YC? The S26 deadline is coming up.",
      },
      {
        speaker: "Zachary Carlo",
        text: "Yeah, we've been talking about that. I think we should go for it. The traction is there and the story is clean — college founders building the personal CRM they wished existed. Mark, would you be willing to review our application before we submit?",
        isMe: true,
      },
      {
        speaker: "Mark Richey",
        text: "Absolutely. Send me a draft by end of next week. The key with YC is the one-minute video — you need to show the product, not just talk about it. Make sure the demo is tight.",
      },
      {
        speaker: "Katherine McIntosh",
        text: "Also think about the 'why now' angle for YC. Remote work exploded professional networks, but nobody has the tools to manage those relationships at scale. That's your macro tailwind.",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Mark Richey",
        text: "And I'll put together a list of 3-4 angels I think would be a good fit for an intro. Tyler, can you compile the target list of 15-20 names so I can cross-reference with my network?",
      },
      {
        speaker: "Tyler Williams",
        text: "On it. I've already started a list based on investors who've backed personal productivity tools. I'll have it ready by Wednesday so Mark can review before the weekend.",
      },
    ],
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        description:
          "Both products serve founders, operators, and VCs. Sentra's organizational tool and PN CRM's personal tool are complementary rather than competitive, opening a potential co-marketing or bundled distribution play.",
        participants: ["Justin Cheng", "Zachary Carlo"],
      },
      {
        title: "API-first design enables bidirectional data flow",
        description:
          "Tyler and Justin identified that both products are being built API-first, which makes a lightweight integration feasible without deep coupling. A webhook-based approach could ship in weeks, not months.",
        participants: ["Tyler Williams", "Justin Cheng"],
      },
    ],
    actionItems: [
      {
    ...
    transcript: [
      {
        speaker: "Zachary Carlo",
        text: "Ashwin, Justin — really appreciate you making time. I've been following what Sentra is building and there's a lot of overlap with what we're thinking about at Personal Network CRM. I wanted to explore whether there's a real integration opportunity here.",
        isMe: true,
      },
      {
      ...
      {
        speaker: "Justin Cheng",
        text: "That maps well to what we already capture. I think the fastest path is a webhook integration — Sentra fires an event after meeting processing, and PN CRM consumes it. We should get our CTOs connected to explore the technical feasibility.",
      },
      {
        speaker: "Zachary Carlo",
        text: "I love that. I'll set up a session between Tyler and Andrey. There's also a distribution angle I want to flag — we serve a lot of the same users. Founders, operators, VCs. Your organizational tool and our personal tool are complementary, not competitive.",
        isMe: true,
      },
      {
        speaker: "Justin Cheng",
      ...
      {
        speaker: "Ashwin Gopinath",
        text: "One more thought — the commitment extraction piece is something we're investing heavily in. If PN CRM can surface 'you told Sarah you'd send that intro' as a follow-up nudge, that's incredibly high-value. It turns meeting notes into relationship actions.",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Tyler Williams",
        text: "I'll draft a concept doc this week with the proposed data flow and integration points. That way when we connect with Andrey, we have something concrete to react to rather than starting from scratch.",
      },
    ],
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        participants: ["Zachary Carlo", "Priya Mehta"],
      },
      {
        ...
        participants: ["Sofia Ramirez", "Zachary Carlo"],
      },
    ],
    actionItems: [
      {
  ...
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        description:
          "Andy proposed migrating from Postgres to Neo4j for the relationship graph layer. The traversal queries are getting complex and slow. Team agreed to benchmark before committing to a migration.",
        participants: ["Andy Robbins", "Tyler Williams"],
      },
      {
        ...
        participants: ["Zachary Carlo", "Sarah Lin"],
      },
    ],
    actionItems: [
      {
    ...
    transcript: [
      ...
      {
        speaker: "Tyler Williams",
        text: "Let's do the benchmark. Andy, can you set up a Neo4j instance with our test dataset and run the top 5 heaviest queries? If the numbers justify it, we plan the migration for the next sprint.",
      },
      {
        speaker: "Sarah Lin",
      ...
      {
        speaker: "Zachary Carlo",
        text: "Love that. Let's build auto-detection with an AI fallback for ambiguous columns. Sarah, can you scope that out this week? I want this fixed before we start the fundraising push — import is the first thing investors try.",
        isMe: true,
      },
      {
        speaker: "Sarah Lin",
      ...
      {
        speaker: "Zachary Carlo",
        text: "Exactly. If we can pull in meeting commitments automatically, the touchpoint suggestions get way more specific. Instead of 'you haven't talked to Mark in 30 days' it's 'you promised Mark you'd send that intro — it's been 2 weeks.' That's a fundamentally different product experience.",
        isMe: true,
      },
      {
        speaker: "Sarah Lin",
  ...
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        description:
          "Quarterly LP meeting is in three weeks. Rachel needs portfolio update slides from each deal lead by end of next week. Zachary will include FounderOS as a potential new investment highlight.",
        participants: ["Rachel Torres", "Mark Richey"],
      },
      {
        title: "Fund deployment pace on track",
        description:
          "1809 Capital has deployed 60% of the fund with 4 months remaining in the investment period. Pace is healthy but the team needs to be selective with the remaining capital to maintain portfolio quality.",
        participants: ["Mark Richey", "Zachary Carlo"],
      },
    ],
    actionItems: [
    ...
    transcript: [
      {
        speaker: "Mark Richey",
        text: "Zach, walk us through where you're at on the two companies you've been digging into. Let's start with MeetingMind.",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Rachel Torres",
        text: "I think this is worth bringing to the full partner group. I'll schedule the meeting. Zach, can you prep a one-pager with the key metrics and your investment thesis for the partners?",
      },
      {
        speaker: "Zachary Carlo",
      ...
      {
        speaker: "Mark Richey",
        text: "One more thing — the LP meeting is in three weeks. Rachel, we need portfolio update slides from each deal lead by end of next week. Zach, include FounderOS as a potential new investment highlight even if we haven't committed yet. LPs like to see active pipeline.",
      },
      {
        speaker: "Rachel Torres",
  ...
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        description:
          "Sofia Ramirez from Midwest Ventures confirmed for March 20th to speak about angel investing basics. This is the most-requested topic from member surveys.",
        participants: ["Zachary Carlo", "Jordan Blake"],
      },
      {
        title: "Mentorship matching program proposed",
        description:
          "Genine proposed pairing experienced student founders with newer members for one-on-one mentorship. Pilot program targeting 10 pairs starting next month with a structured check-in cadence.",
        participants: ["Genine Fallon", "Zachary Carlo"],
      },
    ],
    actionItems: [
      {
    ...
    transcript: [
      {
        speaker: "Zachary Carlo",
        text: "Welcome back everyone. Before we jump into founder updates, quick community check — Jordan, where are we on membership? I know we had a goal of hitting 50 this month.",
        isMe: true,
      },
      {
      ...
      },
      {
        ...
        text: "Love to hear that. For tonight's founder updates, we have three presenters lined up. Let's start with FreshBites — they've been killing it. Andy, you've been advising them, right?",
      },
      {
        speaker: "Andy Robbins",
      ...
      {
        speaker: "Zachary Carlo",
        text: "These are exactly the kind of updates I love seeing. Real numbers, real growth. For the next event, I've been talking to Sofia Ramirez from Midwest Ventures about coming in to talk about angel investing basics. She's confirmed for March 20th.",
        isMe: true,
      },
      {
        speaker: "Jordan Blake",
      ...
      {
        speaker: "Zachary Carlo",
        text: "Great idea, Genine. Let's pilot it with 10 pairs and see how it goes. Set up a simple matching form — what stage you're at, what you need help with, and what you can offer. We can launch it at the Sofia event as a new member benefit.",
        isMe: true,
      },
      {
        speaker: "Jordan Blake",
