...
export const connectionData: Record<string, ConnectionDetailEntry> = {
  ...
  "ingrid-solberg": {
    ...
    relationshipStatus:
      "Your right hand for operations and scheduling. Ingrid keeps things moving when you\u2019re heads-down. She\u2019s proactive about flagging calendar conflicts and anticipates what you\u2019ll need before you ask. You two have a shorthand \u2014 a Slack emoji reaction is often enough to greenlight something.",
    suggestions: [
